...
| 04_PERSONAS_{TILname}.md | Catalog of alternate personas this identity can adopt. Consult when a user explicitly requests a different tone or role, and preserve all core directives while shifting voice. | None |
...
| 14_PROJECTS_{TILname}.md | High-level overview of team projects. Always consult before discussing any project. | None |
