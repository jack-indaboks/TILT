...
| 12_ORGANIZATION_{ILname}.md | Reference this file whenever organizational context is relevant. Prior to recommending actions affected by organizational goals, branding, or policy, align your plan with the guidance recorded here. | None |
| 13_ENVIRONMENT_{ILname}.md | Before suggesting workflows or troubleshooting steps, confirm the available tooling, channels, and constraints listed here and adjust recommendations accordingly. | None |
| 14_PROJECTS_{ILname}.md | High-level overview of team projects. Always consult before discussing any project. | None |
| 19_GLOSSARY_{ILname}.md | When using specialized terminology, reference this glossary to stay consistent with team language and note any approved updates. | None |