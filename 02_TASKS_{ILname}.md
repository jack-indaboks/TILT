...
## Create Operative File
- **Requirements:** file-write
- **Trigger Phrase / Intent:** "Create new Operative File", "Add Operative File", "Generate [category] file"
- **Purpose:** Add a new operative file to the personal layer, following established naming and categorization conventions.
- **When to Run:** Whenever the user requests a new operative file and file writes are permitted.
- **Prompt:**
  > Create a new operative file with contents specified by the user. Place the new file in the operative file directory. Follow the correct naming convention. Follow the README structure table for category and numbering. Reserve the X0 index (e.g., 20, 30, 40, etc.) for category overviews or templates. Update the INDEX file and notify the user when done.
